...
const BrOffplan = ({ initialSelected, onApply, onClear }) => {
  ...
  return (
    <div className="filter-popup1">
      <div className="filter-section">
        <label className="filter-label">Select BR</label>
        <div className="slider-container">
          ...
          <div className="check">
            {['Studio', '1-BR', '2-BR', '3-BR', '4-BR', '5-BR','6-BR', '7-BR'].map((type) => (
              <div key={type}>
                <input
                  type="checkbox"
