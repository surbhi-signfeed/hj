...
function NewBuy({onApply,onClear}) {
...
useEffect(() => {
  ...
  return (
    <div className="App">
          <Helmet>
      <title>Buy </title>
      <meta name="title" content="Property for Sale | HJ Real Estates
" />
        <meta name="description" content="Property for Sale Archive | HJ Real Estates" />
